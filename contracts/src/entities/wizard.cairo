...
impl WizardImpl of FoeTrait::<Wizard> {
    ...
    #[inline(always)]
    fn next(self: Wizard, tile: Tile, target: Tile, size: u32, ref tiles: Felt252Dict<Nullable<Tile>>) -> u32 {
...
mod tests {
    ...
    fn test_bowman_get_hits_top() {
        ...
        let hits = wizard.get_hits(tile, target, SIZE);
        let expected = array![6 + SIZE * 2, 5 + SIZE * 2, 4 + SIZE * 2, 3 + SIZE * 2, 2 + SIZE * 2].span();
        assert(hits.len() == expected.len(), 'Wrong result len');
        assert(hits.at(0) == expected.at(0), 'Wrong result at 0');
        assert(hits.at(1) == expected.at(1), 'Wrong result at 1');
        assert(hits.at(2) == expected.at(2), 'Wrong result at 2');
    ...
    fn test_bowman_get_hits_bottom() {
        ...
        let hits = wizard.get_hits(tile, target, SIZE);
        let expected = array![2 + SIZE * 2, 3 + SIZE * 2, 4 + SIZE * 2, 5 + SIZE * 2, 6 + SIZE * 2].span();
        assert(hits.len() == expected.len(), 'Wrong result len');
        assert(hits.at(0) == expected.at(0), 'Wrong result at 0');
        assert(hits.at(1) == expected.at(1), 'Wrong result at 1');
        assert(hits.at(2) == expected.at(2), 'Wrong result at 2');
    ...
    fn test_bowman_get_hits_left() {
        ...
        let hits = wizard.get_hits(tile, target, SIZE);
        let expected = array![1 + SIZE * 2, 1 + SIZE * 3, 1 + SIZE * 4, 1 + SIZE * 5, 1 + SIZE * 6].span();
        assert(hits.len() == expected.len(), 'Wrong result len');
        assert(hits.at(0) == expected.at(0), 'Wrong result at 0');
        assert(hits.at(1) == expected.at(1), 'Wrong result at 1');
        assert(hits.at(2) == expected.at(2), 'Wrong result at 2');
    ...
    fn test_bowman_get_hits_right() {
        ...
        let hits = wizard.get_hits(tile, target, SIZE);
        let expected = array![1 + SIZE * 6, 1 + SIZE * 5, 1 + SIZE * 4, 1 + SIZE * 3, 1 + SIZE * 2].span();
        assert(hits.len() == expected.len(), 'Wrong result len');
        assert(hits.at(0) == expected.at(0), 'Wrong result at 0');
        assert(hits.at(1) == expected.at(1), 'Wrong result at 1');
        assert(hits.at(2) == expected.at(2), 'Wrong result at 2');
